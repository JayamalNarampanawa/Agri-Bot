...
void setup() {
  ...
  // Initialize Firebase with database secret
  Firebase.begin(&config, nullptr);  // pass nullptr for auth
...
void loop() {
  ...
  Serial.printf("Soil1: %d%% Pump1: %s || Soil2: %d%% Pump2: %s || Tank: %d%% Pump: %s\n",
